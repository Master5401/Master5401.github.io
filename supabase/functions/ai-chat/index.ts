...
serve(async (req) => {
  ...
  try {
    const { messages, membersContext } = await req.json();
...
Provide helpful, professional health advice. Focus on practical guidance for caregivers.`;
